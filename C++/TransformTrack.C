...
TrackTransformer::TrackTransformer(hid_t outputfile, int chunksizes[], hid_t dsp)
{
	...
	H5Tinsert (tracktable, "RunNo", HOFFSET(TrackHeader_t, RunId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "VertexId", HOFFSET(TrackHeader_t, VertexId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "SegmentId", sizeof(TrackHeader_t) + HOFFSET(JPSimTrack_t, nSegmentId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "ParentTrackId", sizeof(TrackHeader_t) + HOFFSET(JPSimTrack_t, nParentTrackId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "TrackId", sizeof(TrackHeader_t) + HOFFSET(JPSimTrack_t, nTrackId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "PrimaryId", sizeof(TrackHeader_t) + HOFFSET(JPSimTrack_t, nPrimaryId), H5T_NATIVE_INT32);
	H5Tinsert (tracktable, "PdgId", sizeof(TrackHeader_t) + HOFFSET(JPSimTrack_t, nPdgId), H5T_NATIVE_INT32);
	...
	H5Tinsert (steppointtable, "RunNo", HOFFSET(StepPointHeader_t, RunId), H5T_NATIVE_INT32);
	...
	H5Tinsert (steppointtable, "ProcessType", sizeof(StepPointHeader_t) + HOFFSET(JPSimStepPoint_t, nProcessType), H5T_NATIVE_INT32); 
	H5Tinsert (steppointtable, "ProcessSubType", sizeof(StepPointHeader_t) + HOFFSET(JPSimStepPoint_t, nProcessSubType), H5T_NATIVE_INT32); 
	...
	H5Tinsert (steppointtable, "TargetZ", sizeof(StepPointHeader_t) + HOFFSET(JPSimStepPoint_t, nTargetZ), H5T_NATIVE_INT32); 
	H5Tinsert (steppointtable, "TargetA", sizeof(StepPointHeader_t) + HOFFSET(JPSimStepPoint_t, nTargetA), H5T_NATIVE_INT32); 
	...
	H5Tinsert (secondaryparticletable, "RunNo", HOFFSET(SecondaryParticle_t, RunId), H5T_NATIVE_INT32);
	...
	H5Tinsert (secondaryparticletable, "SecondaryPdgId;", HOFFSET(SecondaryParticle_t, nSecondaryPdgId), H5T_NATIVE_INT32);
